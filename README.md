...
![](https://github.com/erdsal4/twitter_postgres_parallel/workflows/tests_normalized/badge.svg)

![](https://github.com/erdsal4/twitter_postgres_parallel/workflows/tests_normalized_parallel/badge.svg)

![](https://github.com/erdsal4/twitter_postgres_parallel/workflows/tests_normalized_batch/badge.svg)

![](https://github.com/erdsal4/twitter_postgres_parallel/workflows/tests_normalized_batch_parallel/badge.svg)

![](https://github.com/erdsal4/twitter_postgres_parallel/workflows/tests_denormalized/badge.svg)

![](https://github.com/erdsal4/twitter_postgres_parallel/workflows/tests_denormalized_parallel/badge.svg)
...
| -----------------------| ------------------------- | ------------------------- |
| `pg_normalized`        |    209.4 seconds          |    21.1 seconds           | 
| `pg_normalized_batch`  |    106.2 seconds          |    11.5 seconds           | 
| `pg_denormalized`      |    3.03 seconds           |    0.35 seconds           | 
